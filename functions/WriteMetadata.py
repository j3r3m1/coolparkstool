...
def writeRunInfo(folderPath, build_file, heightBuild,
    ...
    #FO#
    with open(folderPath + '/RunInfoCoolParksTool.txt', 'w') as file:
        file.write('This file provides run settings for the CoolParksTool run initiated at: ' + strftime("%a, %d %b %Y %H:%M:%S"))
        file.write('\n')
        file.write('\n')
        file.write('Version: ' + 'CoolParksTool v2023a')
        file.write('\n')
        file.write('\n')
