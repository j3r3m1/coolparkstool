...
def compareScenarios(refScenarioDirectory, 
    ...
    dict_build_glob = {ENERGY_IMPACT_ABS : [diff_nrj_impact],
                  ENERGY_IMPACT_REL : [diff_nrj_rel],
                  THERM_COMFORT_IMPACT_ABS : [diff_tc_impact],
                  THERM_COMFORT_IMPACT_REL : [diff_tc_rel]}
    pd.DataFrame(dict_build_glob)\
    ...
    for tp in [DAY_TIME, NIGHT_TIME]:
        ...
        if change == "weather" or change == "city":
    ...
    return finalDirectory, dict_build_glob, diff_build_path, diff_deltaT_path, diff_T_path, diff_build_extremums